...
\cvlistitem{This project introduces a new open source platform for end-to-end speech processing~\cite{Watanabe2018}.}
\cvlistitem{Develop and maintain ASR and TTS pytorch backend, and continuous integration (CI) for unittesting and sphinx documentation. For example, my early PR made ESPnet 3-4 times faster. \url{https://github.com/espnet/espnet/pull/17}}
