...
\cvlistitem{My research interests include noise robust ASR~\cite{Karita2017}, far-field ASR~\cite{Yoshioka2015}, sequential training~\cite{karita_icassp2018} and semi-supervised training~\cite{Karita_interspeech2018,karita_icassp2019} for end-to-end ASR models and acoustic models.\newline}
...
\cvlistitem{I mainly develop, maintain and review ASR and TTS pytorch backends, and continuous integration (CI) for unittesting and sphinx documentation. For example, my early contribution made ESPnet 3-4 times faster. \url{https://github.com/espnet/espnet/pull/17}}
...
\cvitem{Language}{Japanese (native), English (full professional)}
...
{\footnotesize \bibliographyproceedings{proceedings}}

\nocitetalk{*}
\bibliographystyletalk{ieeetr}
{\footnotesize \bibliographytalk{talk}}

\subsection{Patents}
Contributed to more than 5 patents at NTT

\section{Supervisor for student}
Research Internship at NTT Communication Science Laboratories
\begin{enumerate}
    \item 2018.08 - 2018.09: Chonghui Zheng (Tokyo Institute of Technology)
    \item 2017.08 - 2017.09: Takeru Yokota (Kyoto University)
\end{enumerate}
